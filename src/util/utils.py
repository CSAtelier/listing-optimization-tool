...
from src.revenue_calculator_api.revenue_calculator import *
import pandas as pd
...
def revenue_calculator(data_path,column):
    ...
    for i in range(len(df['ASIN'])):
        product = get_arbitrage_product("B08B2GFJ1C", Country.USA, Country.CANADA, Currency.USD, Currency.CAD, 1.3, 4.0)
        print(product)
